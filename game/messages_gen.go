...
// DecodeMsg implements msgp.Decodable
func (z *OpenPortalStatusMessage) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *OpenPortalStatusMessage) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 6
	// write "Success"
	err = en.Append(0x86, 0xa7, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73)
	if err != nil {
		return
	}
...
// MarshalMsg implements msgp.Marshaler
func (z *OpenPortalStatusMessage) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 6
	// string "Success"
	o = append(o, 0x86, 0xa7, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *OpenPortalStatusMessage) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *OpenPortalStatusMessage) Msgsize() (s int) {
	s = 1 + 8 + msgp.BoolSize + 7 + msgp.StringPrefixSize + len(z.Reason) + 7 + msgp.StringPrefixSize + len(z.Opener) + 7 + msgp.StringPrefixSize + len(z.LandId) + 10 + msgp.Int64Size + 10 + msgp.Int64Size
	return
}
